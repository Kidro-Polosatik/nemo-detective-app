// js/engine/test-scene.js - Полная ВН-версия эпизода 1 с реальными путями
...
window.episodes['test_vn'] = {
    ...
    vnScenes: [
        ...
        // СЦЕНА 5: Представление детективов
        {
            ...
            dialog: {
                speaker: "jupiter",
                text: "Я – Юпитер Джонс, это мои друзья Боб и Пит. Ворвингтон – наш водитель. Мы детективы. – и он протянул мне визитную карточку с тремя нарисованными на ней знаками вопросов."
            }
        },
        ...
        // СЦЕНА 7: Диалог о попугае
        {
            ...
            dialog: {
                speaker: "pete",
                text: "Неужели мистер Фентрисс нанял еще детектива, а мы его чуть не сбили?! – воскликнул один из мальчишек, кажется Пит. - Вы тоже расследуете дело попугая-заики?"
            }
        },
        ...
        // СЦЕНА 8: Ответ и вопрос о прогрессе
        {
            ...
            dialog: {
                speaker: "jupiter",
                text: "Да, получается, мы коллеги. Вам уже удалось что-то выяснить? – спросил я"
            }
        },
        ...
        // СЦЕНА 9: Информация о попугае
        {
            ...
            dialog: {
                speaker: "jupiter",
                text: "Мы только начали, знаем, что пропавший попугай повторял «Быть или не быть». Знаменитый монолог Гамлета. Я вспомнил и это. Вот в чем вопрос."
            }
        },
...
console.log('✅ Полная ВН-версия эпизода 1 загружена (11 сцен)');
